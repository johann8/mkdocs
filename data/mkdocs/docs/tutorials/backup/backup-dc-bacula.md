...
![Konfiguration Job](../../assets/screenshots/bacula_dc_job.jpg "Bacula Docker Job"){width=700}

- Director => Configure director => JobDefs => rockyl8-docker-stopScript-job => edit <br>
![Konfiguration JobDefs](../../assets/screenshots/bacula_dc_jobdefs.jpg "Bacula Docker JobDefs"){width=700}

- Director => Configure director => JobDefs => rockyl8-docker-stopScript-fs => edit <br>
![Konfiguration Fileset Bild 1](../../assets/screenshots/bacula_dc_fileset1.jpg "Bacula Docker FileSet"){width=700}<br>
![Konfiguration Fileset Bild 2](../../assets/screenshots/bacula_dc_fileset1.jpg "Bacula Docker FileSet"){width=700}
